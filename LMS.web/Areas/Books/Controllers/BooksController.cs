...
namespace LMS.web.Areas.Books.Controllers
{
    ...
    public class BooksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("BookId,Title,NumberOfCopies,IsEnabled,CategoryId,ImageUrl")] Book book)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BookId,Title,NumberOfCopies,IsEnabled,CategoryId,ImageUrl")] Book book)
        {
            if (id != book.BookId)
            {
                return NotFound();
